...
@Component
public class ExceptionDeviceOrchestration {
    private final Logger log = LoggerFactory.getLogger(this.getClass());


    @Autowired
    private ListService<ExceptionDevice> service;
    ...
    private String enableConfigKey = SystemConfigKeys.ENABLE_PROCESSING_EXCEPTION_LIST;
            ...
            try {
                while (!isAlreadyRunning) {
                    ...
                    if (timeToRun == 0) {
                        ...
                        DeviceSyncRequestPointer deviceSyncRequestPointer = deviceSyncRequestPointerService.getLastProcessedDate(DeviceSyncRequestListIdentity.EXCEPTION_LIST);
                ...
                moduleAlertService.sendDatabaseAlert(e.getMessage(), DeviceSyncRequestListIdentity.EXCEPTION_LIST);
            }
            try {
    ...
    private Boolean isEnabled() {
        String isEnable = config.findByKey(SystemConfigKeys.ENABLE_PROCESSING_EXCEPTION_LIST, "NO");
