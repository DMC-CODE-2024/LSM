...
@Component
public class BlockedTacOrchestration {
    private final Logger log = LoggerFactory.getLogger(this.getClass());

    @Autowired
    private ListService<BlockedTac> service;
    ...
    private String enableConfigKey = SystemConfigKeys.ENABLE_PROCESSING_BLOCKED_TAC;
            ...
            try {
                while (!isAlreadyRunning) {
                    ...
                    if (timeToRun == 0) {
                        ...
                        DeviceSyncRequestPointer deviceSyncRequestPointer = deviceSyncRequestPointerService.getLastProcessedDate(DeviceSyncRequestListIdentity.BLOCKED_TAC);
                ...
                moduleAlertService.sendDatabaseAlert(e.getMessage(), DeviceSyncRequestListIdentity.BLOCKED_TAC);
    ...
    private Boolean isEnabled() {
        String isEnable = config.findByKey(SystemConfigKeys.ENABLE_PROCESSING_BLOCKED_TAC, "NO");
